...
const UserAdd = () => {
  ...
  return (
    <Form {...formItemLayout} form={form} name="add" className={styles.addForm} onFinish={onFinish} scrollToFirstError>
      <Form.Item
        name="name"
        label="姓名"
        rules={[
      ...
      <Form.Item name="deptName" label="部门" rules={[{ required: true, message: '请选择部门' }]}>
